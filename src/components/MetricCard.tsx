    ...
    return (
        <div className="flex flex-col justify-between py-4 border-t border-black dark:border-white group">
            <div className="flex justify-between items-start mb-4">
                <h3 className="font-mono text-xs uppercase tracking-widest text-zinc-500 dark:text-zinc-400 group-hover:text-cream-600 dark:group-hover:text-cream-500 transition-colors">
                    {title}
                </h3>
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-cream-600 dark:text-cream-500">
